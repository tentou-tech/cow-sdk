...
export async function createBungeeDepositCall(params: {
  ...
  const functionParams = BungeeTxDataBytesIndices[bridge][functionSelector]
  ...
  const callData = adapter.utils.encodeFunction(BUNGEE_APPROVE_AND_BRIDGE_V1_ABI, 'approveAndBridge', [
